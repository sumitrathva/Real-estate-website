        ...
        msg.sender === currentUser._id ? (
            ...
            >
                <div className="User_chat mt-2">
                    ...
                    <p ref={scrollRef} className="text-lg font-normal bg-blue-900/80 px-2 text-white py-1 rounded-md">
                        {msg.message}
                    </p>
                </div>
            </div>
            ...
            >
                <div className="User_chat flex items-center gap-2 mt-2">
                    ...
                    <div>
                        ...
                        {/* Display Text Message */}
                        <p ref={scrollRef} className="text-lg font-normal bg-blue-500 px-2 text-white py-1 rounded-md">
                            {msg.message}
                        </p>
                    </div>
                </div>
