...
const ListingPage = () => {
                                    ...
                                    <div className="lg:col-span-7  ">
                                        <div className='bg-white md:p-12 p-6 rounded-md shadow-sm shadow-brand-blue'>
                                            <div className="property_info">
                                                ...
                                                {
    offer ? (
        <p className='text-2xl font-heading text-brand-blue mt-5 font-bold'>
            ₹{discountPrice} <span>
                <s className='text-gray-400 text-sm'>₹{price}</s>
            </span>
        </p>
    ) : (
        <p className='text-2xl font-heading text-brand-blue mt-3 font-bold'>
            ₹{price}
        </p>
    )
}
    ...
    offer && (
        <div className="grid grid-cols-2 mt-2">
            <p className="font-heading text-md lg:text-lg">Price</p>
